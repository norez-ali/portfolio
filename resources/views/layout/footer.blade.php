    ...
    <div class="container">
        <div class="overflow-x-hidden" data-aos="flip-down" data-aos-delay="500">
            <div class="footer-grid">
                <div class="pt-12">
                    ...
                    <div class="d-flex flex-wrap align-items-center mt-10">
                        <span class="text-xl fw-bold font-Syne text-white">Based in Pakistan |</span>
                        <div class="footer-social">
                            <ul
                                class="d-flex flex-wrap gap-x-4 align-items-center list-unstyled p-0 footer-social-links">

                                <li><a href="https://www.linkedin.com/in/norez-ali-362294352" target="_blank"
                                        class="text-white footer-social-link"><svg width="24" height="24"
                                ...
                                <li><a href="https://github.com/norez-ali" target="_blank"
                                        class="text-white footer-social-link"><svg width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                ...
                <div class="d-flex flex-column justify-content-between service-contact-card-footer">
                    <h3 class="text-xl fw-bold font-Syne text-white">Looking for a hectic developer?</h3>
                    <div class="d-flex justify-content-between align-items-center">
                        <p class="text-2xl fw-bold font-Syne leading-none text-warning">norezali.dev@gmail.com</p>
                        <a href="https://mail.google.com/mail/?view=cm&fs=1&to=norezali.dev@gmail.com" target="_blank"
                            class="text-white animate-arrow-up">
                ...
                <div class="d-flex flex-column justify-content-between service-contact-card-footer">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <p class="text-2xl fw-bold font-Syne leading-none text-warning">+ 92 325 8061043</p>
                        <a href="https://wa.me/923258061943" target="_blank" rel="noopener noreferrer"
                            class="text-white animate-arrow-up">
                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M11.6667 28.3334L28.3334 11.6667" stroke="currentColor" stroke-width="1.5"
            ...
            <div class="row">
                <div class="col-12">
                    <div class="py-72">
                        {{-- <svg class="w-100" width="1281" height="77" viewBox="0 0 1281 77" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <img src="{{ asset('assets/images/icon/name.svg') }}" alt="Norez Ali"class="w-100">
                    </div>
                </div>
            ...
            <div class="pt-6 copyright">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-8 order-last order-sm-first">
                        <p class="text-white text-lg fw-normal font-sans leading-7">©2025 Norez Ali, All
                            Rights Reserved
                        </p>
                    </div>
